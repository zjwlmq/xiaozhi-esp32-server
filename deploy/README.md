...
本目录用于部署“火山 API Key 兼容版”。两个系统使用相同的程序镜像，只在宿主机
...
- `ghcr.io/zjwlmq/xiaozhi-esp32-server:server_volc-api-key-1.0.0-rc.1`
- `ghcr.io/zjwlmq/xiaozhi-esp32-server:web_volc-api-key-1.0.0-rc.1`
...
API Key、应用 ID、访问令牌等密钥不得提交到 GitHub。

该版本已经通过请求头、Python、YAML 和部署脚本静态测试。由于真实双向语音调用
