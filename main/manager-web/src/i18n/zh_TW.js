export default {
  ...
  'modelConfig.rag': '知識庫',
  'modelConfigDialog.credential_empty': '未填寫 API Key',
  'modelConfigDialog.credential_filled': '已填寫（是否可用請測試連線）；管理員可見明文，請勿公開截圖',
  'modelConfigDialog.credential_placeholder': '這是範例佔位文字，不是實際金鑰',
  'modelConfigDialog.credential_masked': '目前只是遮罩，請重新開啟編輯視窗或填寫實際金鑰',
  'modelConfigDialog.credential_invalid': '金鑰包含空格、換行或非英文字元，請檢查',
  'modelConfigDialog.apiKeyRequired': '模型「{name}」請填寫實際 API Key，不要填寫佔位文字或遮罩',
  'modelConfigDialog.editorLoadFailed': '模型設定讀取失敗，請重新開啟編輯視窗；目前無法儲存',
  ...
  'modelConfigDialog.upstreamTools': '上游模型檢測',
  'modelConfigDialog.upstreamToolsHint': '由服務端代發請求，可取得模型清單並驗證密鑰、請求標頭與模型是否可用',
  'modelConfigDialog.fetchUpstreamModels': '取得上游模型',
  'modelConfigDialog.testConnection': '一鍵測試',
  'modelConfigDialog.upstreamTestTitle': '測試上游模型連線',
  'modelConfigDialog.testModel': '測試模型',
  'modelConfigDialog.selectOrEnterModel': '選擇或輸入模型ID',
  'modelConfigDialog.refresh': '重新整理',
  'modelConfigDialog.testPrompt': '測試訊息，預設 hi',
  'modelConfigDialog.testSuccess': '測試成功',
  'modelConfigDialog.testFailed': '測試失敗',
  'modelConfigDialog.modelsLoaded': '模型清單取得成功',
  'modelConfigDialog.modelsFound': '共取得 {count} 個模型，選中後會同步到表單',
  'modelConfigDialog.close': '關閉',
  'modelConfigDialog.runTest': '重試',
  'modelConfigDialog.modelRequired': '請先選擇或填寫模型ID',
  'modelConfigDialog.emptyResponse': '上游回傳成功，但沒有可顯示的文字',
  'modelConfigDialog.unknownTestError': '上游請求失敗，請檢查設定與服務端日誌',
  ...
  'ttsModel.syncUpstreamTitle': '同步火山引擎聲音復刻音色',
  'ttsModel.cloneVersion': '復刻模型',
  'ttsModel.cloneVersion1': '豆包-聲音復刻 1.0',
  'ttsModel.cloneVersion2': '豆包-聲音復刻 2.0',
  'ttsModel.refreshUpstream': '重新獲取',
  'ttsModel.upstreamCredentialTip': '請先在當前模型配置中填寫 AppID 和 OpenAPI AK/SK',
  'ttsModel.upstreamState': '上游狀態',
  'ttsModel.importState': '匯入狀態',
  'ttsModel.imported': '已匯入',
  'ttsModel.selectedVoiceCount': '已選 {count} 個音色',
  'ttsModel.importSelected': '匯入所選音色',
  'ttsModel.fetchUpstreamFailed': '獲取上游音色失敗',
  'ttsModel.importFailed': '匯入上游音色失敗',
  'ttsModel.importSuccess': '匯入成功 {imported} 個，跳過 {skipped} 個',
