export default {
  ...
  'modelConfig.rag': 'RAG',
  'modelConfigDialog.credential_empty': 'Chưa nhập API Key',
  'modelConfigDialog.credential_filled': 'Đã nhập, chưa xác minh. Hãy kiểm tra kết nối. Khóa hiển thị cho quản trị viên; không chia sẻ ảnh chụp.',
  'modelConfigDialog.credential_placeholder': 'Đây là văn bản mẫu, không phải khóa thật',
  'modelConfigDialog.credential_masked': 'Chỉ có giá trị bị che. Mở lại cửa sổ sửa hoặc nhập khóa thật.',
  'modelConfigDialog.credential_invalid': 'Kiểm tra khoảng trắng, xuống dòng hoặc ký tự không phải ASCII trong khóa',
  'modelConfigDialog.apiKeyRequired': 'Nhập API Key thật cho “{name}”, không nhập văn bản mẫu hoặc giá trị bị che',
  'modelConfigDialog.editorLoadFailed': 'Không tải được mô hình. Mở lại cửa sổ sửa trước khi lưu.',
  ...
  'modelConfigDialog.upstreamTools': 'Kiểm tra mô hình thượng nguồn',
  'modelConfigDialog.upstreamToolsHint': 'Máy chủ kiểm tra mô hình, thông tin xác thực và header mà không lộ API key',
  'modelConfigDialog.fetchUpstreamModels': 'Lấy danh sách mô hình',
  'modelConfigDialog.testConnection': 'Kiểm tra kết nối',
  'modelConfigDialog.upstreamTestTitle': 'Kiểm tra kết nối mô hình',
  'modelConfigDialog.testModel': 'Mô hình kiểm tra',
  'modelConfigDialog.selectOrEnterModel': 'Chọn hoặc nhập ID mô hình',
  'modelConfigDialog.refresh': 'Làm mới',
  'modelConfigDialog.testPrompt': 'Tin nhắn kiểm tra, mặc định: hi',
  'modelConfigDialog.testSuccess': 'Kiểm tra thành công',
  'modelConfigDialog.testFailed': 'Kiểm tra thất bại',
  'modelConfigDialog.modelsLoaded': 'Đã tải danh sách mô hình',
  'modelConfigDialog.modelsFound': 'Tìm thấy {count} mô hình. Lựa chọn sẽ được chép vào biểu mẫu.',
  'modelConfigDialog.close': 'Đóng',
  'modelConfigDialog.runTest': 'Thử lại',
  'modelConfigDialog.modelRequired': 'Hãy chọn hoặc nhập ID mô hình trước',
  'modelConfigDialog.emptyResponse': 'Yêu cầu thành công nhưng không có văn bản hiển thị',
  'modelConfigDialog.unknownTestError': 'Yêu cầu thượng nguồn thất bại. Kiểm tra cấu hình và nhật ký.',
  ...
  'ttsModel.syncUpstreamVoices': 'Đồng bộ giọng upstream',
  'ttsModel.syncUpstreamTitle': 'Đồng bộ giọng sao chép Volcengine',
  'ttsModel.cloneVersion': 'Mô hình sao chép',
  'ttsModel.cloneVersion1': 'Doubao Voice Clone 1.0',
  'ttsModel.cloneVersion2': 'Doubao Voice Clone 2.0',
  'ttsModel.refreshUpstream': 'Làm mới',
  'ttsModel.upstreamCredentialTip': 'Hãy cấu hình AppID và OpenAPI AK/SK trên mô hình hiện tại trước',
  'ttsModel.upstreamState': 'Trạng thái upstream',
  'ttsModel.importState': 'Trạng thái nhập',
  'ttsModel.imported': 'Đã nhập',
  'ttsModel.selectedVoiceCount': 'Đã chọn {count} giọng',
  'ttsModel.importSelected': 'Nhập giọng đã chọn',
  'ttsModel.fetchUpstreamFailed': 'Không thể tải giọng upstream',
  'ttsModel.importFailed': 'Không thể nhập giọng upstream',
  'ttsModel.importSuccess': 'Đã nhập {imported}; bỏ qua {skipped}',
